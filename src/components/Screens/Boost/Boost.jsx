  ...
  return (
    <div className="boost b-btn" id={type}>
      ...
      <div className="boost__button">
        <button className='a-btn' onClick={openBoosUpdate} disabled={!prices[level - 1]}>{prices[level - 1] ? <>Улучшить<span className="boost-arrow">&raquo;</span></> : <div className="boost__max">МАКС</div>}</button>
      </div>
